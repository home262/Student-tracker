...
public class DashboardController implements StudentAware {
    ...
    // Quick-link buttons (fx:id added in FXML)
    @FXML private javafx.scene.control.Button btnViewAllGrades;
    @FXML private javafx.scene.control.Button btnViewOmens;
    @FXML private javafx.scene.control.Button btnForgeReport;
    @FXML private javafx.scene.control.Button btnActionGrades;
    @FXML private javafx.scene.control.Button btnActionAttendance;
    @FXML private javafx.scene.control.Button btnActionOracle;

    private Student student;
    private MainController mainController; // injected by MainController after load

    /** Called by MainController so this controller can trigger sidebar navigation. */
    ...
    // ── Quick-navigation actions (called from FXML buttons) ───────────────────

    @FXML private void goToGrades()     { if (mainController != null) mainController.navigateTo("grades"); }
    @FXML private void goToAttendance() { if (mainController != null) mainController.navigateTo("attendance"); }
    @FXML private void goToReports()    { if (mainController != null) mainController.navigateTo("reports"); }
    @FXML private void goToOracle()     { if (mainController != null) mainController.navigateTo("advisor"); }
